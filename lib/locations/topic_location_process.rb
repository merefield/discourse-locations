...
module ::Locations
  class TopicLocationProcess
    def self.upsert(topic)
      if topic.nil? || !topic.custom_fields["location"].present? ||
           topic.custom_fields["location"]["geo_location"].blank? ||
           !topic.custom_fields["location"]["geo_location"]["lat"].present? ||
      ...
      ::Locations::TopicLocation.upsert(
        {
          ...
          international_code:
            topic.custom_fields["location"]["international_code"] || nil,
